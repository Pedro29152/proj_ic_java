...
public class ProjicRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        var orientadoresProjeto12 = new OrientadoresProjeto(proj1, orientador1, TipoOrientador.CO_ORIENTADOR);
        var orientadoresProjeto21 = new OrientadoresProjeto(proj2, orientador1, TipoOrientador.ORIENTADOR);
        var orientadoresProjeto22 = new OrientadoresProjeto(proj2, orientador2, TipoOrientador.CO_ORIENTADOR);
        var orientadoresProjeto31 = new OrientadoresProjeto(proj3, orientador1, TipoOrientador.ORIENTADOR);
        var orientadoresProjeto32 = new OrientadoresProjeto(proj3, orientador2, TipoOrientador.CO_ORIENTADOR);
        var orientadoresProjeto41 = new OrientadoresProjeto(proj4, orientador1, TipoOrientador.ORIENTADOR);
        var orientadoresProjeto42 = new OrientadoresProjeto(proj4, orientador2, TipoOrientador.CO_ORIENTADOR);
        var orientadoresProjeto51 = new OrientadoresProjeto(proj5, orientador1, TipoOrientador.ORIENTADOR);
        var orientadoresProjeto52 = new OrientadoresProjeto(proj5, orientador2, TipoOrientador.CO_ORIENTADOR);
        var orientadoresProjeto61 = new OrientadoresProjeto(proj6, orientador1, TipoOrientador.ORIENTADOR);
        var orientadoresProjeto62 = new OrientadoresProjeto(proj6, orientador2, TipoOrientador.CO_ORIENTADOR);
        var orientadoresProjeto71 = new OrientadoresProjeto(proj7, orientador1, TipoOrientador.ORIENTADOR);
        var orientadoresProjeto72 = new OrientadoresProjeto(proj7, orientador2, TipoOrientador.CO_ORIENTADOR);
